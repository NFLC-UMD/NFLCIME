 ...
 *
 * @class NFLCIME.cvt.bengali.bengali.auto
 * @extends NFLCIME.CVT
 *
 */
	...
	module: {
		...
		initialize: function() {
			...
			for (var i = 0; i < list.length; i++) {
				var module = list[i];
				switch (module.id) {
					case 'cvt.bengali.bengali.amardesh':
						this.amardeshConverter = module;
						break;
					case 'cvt.bengali.bengali.bangla2000':
						this.bangla2000Converter = module;
						break;
					case 'cvt.bengali.bengali.bangsee':
						this.bangseeConverter = module;
						break;
					case 'cvt.bengali.bengali.boishakhi':
						this.boishakhiConverter = module;
						break;
					case 'cvt.bengali.bengali.prothoma':
						this.prothomaConverter = module;
						break;
					case 'cvt.bengali.bengali.sutonny':
						this.sutonnyConverter = module;
						break;
				}
			}
		},
