NFLCIME.dispatchEvent( { type:'ModuleAdd', module:
{
	...
	initialize:function() {
		...
		for(var i = 0; i < list.length; i++) {
			var module = list[i];
			switch(module.id) {
				case 'cvt.burmese.burmese.bit': this.bitConverter = module; break;
				case 'cvt.burmese.burmese.myan': this.myanConverter = module; break;
				case 'cvt.burmese.burmese.wininnwa': this.wininnwaConverter = module; break;
				case 'cvt.burmese.burmese.winmyanmar': this.winmyanmarConverter = module; break;
				case 'cvt.burmese.burmese.zawgyi': this.zawgyiConverter = module; break;
			}
		}
	},
	bitConverter:null,
