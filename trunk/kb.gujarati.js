...
NFLCIME.dispatchEvent( { type:'ModuleAdd', module:
{
	...
	componentUnicodeGroups:[
		...
		{ type:'consonantAppearingAsSignPre',	pattern:'\u0ab0\u0acd' },		// RA halant
		{ type:'consonantAppearingAsSignPost',	pattern:'\u0acd\u0ab0' },		// halant RA
		{ type:'consonantHalfForms',		pattern:'[\u0a95-\u0ab9]\u0acd' },
		{ type:'consonant',			pattern:'[\u0a95-\u0ab9]' },
		{ type:'consonantModifiers',		pattern:'[\u0abc\u0acd]' },
		{ type:'vowelSign',			pattern:'[\u0ac1-\u0ac8\u0ae2\u0ae3]' },
		{ type:'vowelAppearingOnLeft',		pattern:'[\u0abf]' },
		{ type:'vowelAppearingOnRight',		pattern:'[\u0abe\u0ac0\u0ac9\u0acb\u0acc]' },
		{ type:'syllableModifiers',		pattern:'[\u0a81-\u0a83]' },
		{ type:'vowelIndependent', 		pattern:'[\u0a85-\u0a94\u0ae0\u0ae1]' }
	],
	decomposition:[
		{ from:'\u0a86', to:'\u0a85\u0abe' },
		{ from:'\u0a8d', to:'\u0a85\u0ac5' },
