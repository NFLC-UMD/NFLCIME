NFLCIME.dispatchEvent( { type:'ModuleAdd', module:
{
	...
	dependency:['cvt.gujarati.gujarati.gopika', 'cvt.gujarati.gujarati.krishnaweb', 'cvt.gujarati.gujarati.surya'],
	inheritance:['cvt'],
	lang:'gu',
	...
	initialize:function() {
		...
		for(var i = 0; i < list.length; i++) {
			var module = list[i];
			switch(module.id) {
				case 'cvt.gujarati.gujarati.gopika': this.gopikaConverter = module; break;
				case 'cvt.gujarati.gujarati.krishnaweb': this.krishnawebConverter = module; break;
				case 'cvt.gujarati.gujarati.surya': this.suryaConverter = module; break;
			}
		}
	},
